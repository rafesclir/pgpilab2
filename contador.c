...
#include<stdlib.h>
main(){
//se declaran las dos variables contadoras para numeros par e inpares
int i,k,contadorpar =0,contadorinpar=0;
...
printf("%d: es impar\n",i);
//cuando un numero sea inpar el contador de inpares va sumar 1 a lo que ya tenia actualmente
contadorinpar++;
}
